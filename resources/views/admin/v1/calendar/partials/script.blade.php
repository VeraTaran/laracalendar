    ...
    $(function () {
        ...
        var calendar = new Calendar(calendarEl, {
            ...
            drop      : function(info) {
                ...
                // let url = '/admin/v1/page/calendar';
            ...
            eventDrop: function(info) {
                ...
                var event_id = info.el.getAttribute('data-event-id');
                // let url = '/admin/v1/page/calendar/update/' + event_id;
                let url = '/api/v1/calendar/' + event_id;
                let token = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
                fetch(url, {
                    headers: {
                        "Content-Type": "application/json",
        ...
        $('#add-new-event').click(function (e) {
            ...
            add_event(event.text(val), currColor );
